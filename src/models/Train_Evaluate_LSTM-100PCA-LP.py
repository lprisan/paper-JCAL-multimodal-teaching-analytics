...
# LUIS
def create_LSTM3_PCA(batch_size = 1, trainShape1=100, outs=5):
...
# model = create_LSTM_PCA(batch_size = 1, trainShape1=100, outs);
...
batch = 1
epochs = 50
model = create_LSTM3_PCA(batch_size = 1, trainShape1=k, outs=dummy_y_train.shape[1])
print model.summary()
#############################################################################
